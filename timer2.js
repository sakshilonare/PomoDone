...
// Audio files
var click_sound = new Audio("bell.mp3");
var bell = new Audio("bell.mp3");

// Starting template for the timer
function template() {
  document.getElementById("mins").innerHTML = session_minutes;
  document.getElementById("secs").innerHTML = session_seconds;
}

startBtn.addEventListener("click",function start_timer() => {
  click_sound.play();
